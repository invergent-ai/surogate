...
- [ ] Multi-GPU pre-quant MoE acceptance: [`qwen36moe-lora-fp8.yaml`](examples/sft/qwen36moe/qwen36moe-lora-fp8.yaml). Descriptor/schema requirements are present, but acceptance is pending norm-stability review.
- [ ] Multi-GPU Qwen3 MoE NVFP4 acceptance: [`qwen3moe-nvfp4.yaml`](examples/sft/qwen3moe/qwen3moe-nvfp4.yaml). Currently blocked by the step-3 GPU-side hang described above.
