...
- [x] Direct real-model run passed for [`qwen35-text-lora-fp8.yaml`](examples/sft/qwen35/qwen35-text-lora-fp8.yaml) on 2026-04-27 with `SUROGATE_BLOCK_SCHEMA_PLAN_ASSERT=1`; 24/24 schema records present, zero missing schema activation slots, schema allocation savings estimate `905969664` bytes, loss moved `1.7376 -> 1.1233`, artifact saved to `regression_baselines/runs/qwen35-text-lora-fp8-direct-20260427.json`, log `output_q35/log-nursing-scalar-20260427-061635.json`.
