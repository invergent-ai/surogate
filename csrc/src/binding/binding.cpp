...
NB_MODULE(_surogate, m) {
    ...
    nb::class_<serve::NativeHttpServerConfig>(m, "NativeHttpServerConfig",
        ...
        .def_rw("long_prefill_token_threshold", &serve::NativeHttpServerConfig::long_prefill_token_threshold)
        .def_rw("max_num_partial_prefills", &serve::NativeHttpServerConfig::max_num_partial_prefills)
