...
void quantize_nvfp4_4o6_stochastic_cutlass_auto_scale(uint8_t* out_fp4,
    ...
    switch (error_metric) {
        case recipes::FourOverSixErrorMetric::MSE:
            nvfp4_4o6_sm100::quantize_4o6_stochastic_cutlass_mse(out_fp4,
                                                                 block_scales,
                                                                 global_amax,
                                                                 in,
                                                                 M,
            ...
            break;
        case recipes::FourOverSixErrorMetric::L1:
            nvfp4_4o6_sm100::quantize_4o6_stochastic_cutlass_l1(out_fp4,
                                                                block_scales,
                                                                global_amax,
                                                                in,
                                                                M,
            ...
            break;
        case recipes::FourOverSixErrorMetric::AbsMax:
            nvfp4_4o6_sm100::quantize_4o6_stochastic_cutlass_absmax(out_fp4,
                                                                    block_scales,
                                                                    global_amax,
                                                                    in,
                                                                    M,
...
void quantize_nvfp4_4o6_cutlass(Tensor& out_fp4,
    ...
    quantize_nvfp4_4o6_cutlass_auto_scale(out_fp4.get<uint8_t>(),
...
void quantize_nvfp4_4o6_stochastic_cutlass(Tensor& out_fp4,
    ...
    quantize_nvfp4_4o6_stochastic_cutlass_auto_scale(out_fp4.get<uint8_t>(),
                                                     block_scales.get<uint8_t>(),
                                                     global_amax.get<float>(),
                                                     in.get<nv_bfloat16>(),
                                                     M,
