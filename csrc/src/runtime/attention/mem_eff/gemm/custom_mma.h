...
#include <runtime/attention/mem_eff/gemm/custom_mma_multistage.h>
#include <runtime/attention/mem_eff/gemm/custom_mma_pipelined.h>
...
struct MakeCustomMma<cutlass::gemm::threadblock::MmaMultistage<Shape,
    ...
    static int constexpr kStages = kMaxK == cutlass::platform::numeric_limits<int>::max()
                                       ? Stages
...
struct MakeCustomMma<
    cutlass::gemm::threadblock::
        MmaPipelined<Shape, IteratorA, SmemIteratorA, IteratorB, SmemIteratorB, ElementC, LayoutC, Policy>,
    kMaxK> {
    using Mma = cutlass::gemm::threadblock::
        CustomMmaPipelined<Shape, IteratorA, SmemIteratorA, IteratorB, SmemIteratorB, ElementC, LayoutC, Policy>;
};
