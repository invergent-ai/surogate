...
__global__ void
__launch_bounds__(AttentionKernel<cutlass::half_t, cutlass::arch::Sm50, true, 64, 64, 64, true, true>::kNumThreads,
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_64x64_rf_sm50` is for sm50-sm69, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void
__launch_bounds__(AttentionKernel<cutlass::half_t, cutlass::arch::Sm70, true, 64, 64, 64, true, true>::kNumThreads,
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_64x64_rf_sm70` is for sm70-sm74, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void
__launch_bounds__(AttentionKernel<cutlass::half_t, cutlass::arch::Sm75, true, 64, 64, 64, true, true>::kNumThreads,
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_64x64_rf_sm75` is for sm75-sm79, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void
__launch_bounds__(AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, true, 64, 64, 64, true, true>::kNumThreads,
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_64x64_rf_sm80` is for sm80-sm121, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_32x128_rf_sm50` is for sm50-sm69, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_32x128_rf_sm70` is for sm70-sm74, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_32x128_rf_sm75` is for sm75-sm79, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_64x128_rf_sm80` is for sm80-sm121, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_32x128_gmem_sm50` is for sm50-sm69, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_32x128_gmem_sm70` is for sm70-sm74, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_32x128_gmem_sm75` is for sm75-sm79, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
#endif
#endif
    printf("FATAL: kernel `fmha_cutlassF_f16_aligned_32x128_gmem_sm80` is for sm80-sm121, but was built for sm%d\n",
           int(__CUDA_ARCH__ + 0) / 10);
#endif
}
