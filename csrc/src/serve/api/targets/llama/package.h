...
/// The one export profile a Llama artifact carries today. The family's other
/// targets also list NVFP4 and FP8 profiles; nothing quantises a Llama
...
SINFER_TARGET_LOAD_TYPES(llama::Package);
