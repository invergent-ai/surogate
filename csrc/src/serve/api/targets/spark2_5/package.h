...
SINFER_TARGET_LOAD_TYPES(spark2_5::Package);

} // namespace detail

struct Package {
    static constexpr std::array<std::string_view, 1> model_ids{"spark2_5"};
    static constexpr std::string_view model_id = model_ids[0];
    static constexpr std::string_view target_key = "spark2_5";
