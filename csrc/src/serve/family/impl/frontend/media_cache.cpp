...
struct MediaPreprocessCache::Impl {
    ...
    [[nodiscard]] std::shared_ptr<family::PreparedMediaPayload>
    allocate_payload(std::size_t elements, const PreparationControl& control) {
        ...
        family::PreparedMediaPayload* payload = nullptr;
        try {
            payload                 = new family::PreparedMediaPayload();
        ...
        return std::shared_ptr<family::PreparedMediaPayload>(
            payload, [account = std::move(account), bytes](family::PreparedMediaPayload* value) {
                delete value;
...
std::shared_ptr<family::PreparedMediaPayload>
