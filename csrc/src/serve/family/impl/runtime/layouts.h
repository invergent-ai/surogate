...
template <>
struct SequencePlannerImpl<SINFER_FAMILY_VARIANT> {
    SINFER_FAMILY_RUNTIME_NS::SequencePlanningInputs inputs;
    runtime::SequenceCapacityCurve curve;
    std::unique_ptr<SequencePlanImpl<SINFER_FAMILY_VARIANT>> minimum;
};
...
using SequencePlanImpl = family::detail::SequencePlanImpl<Variant>;
