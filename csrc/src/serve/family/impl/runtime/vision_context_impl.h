...
VisionWorkspaceLayout build_workspace_layout(const family::VisionGeometry& g,
...
VisionContext::VisionContext(DeviceContext& ctx, const LoadedModelData& weights) : ctx_(ctx) {
    ...
    cfg_               = bound_vision_geometry(weights.vision_geometry, weights.geometry);
...
std::size_t VisionContext::workspace_bytes(const family::VisionGeometry& geometry,
...
std::size_t VisionContext::output_transient_bytes(const family::VisionGeometry& geometry,
...
std::size_t VisionContext::workspace_capacity_bytes(const family::VisionGeometry& geometry,
...
void VisionContext::encode(const VisionItemView& item, Tensor& output,
    ...
    const family::VisionItemControl& control = *item.control;
    const family::VisionGeometry& g          = cfg_;
