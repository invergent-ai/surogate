...
def _build_text_recipes() -> tuple[TensorRecipe, ...]:
    recipes: list[TensorRecipe] = [
        TensorRecipe(
            ...
            _source("model.embed_tokens.weight", (248320, 1024)),
        )
    ]
    ...
    for layer in range(24):
        ...
        recipes.append(
            TensorRecipe(
                ...
                _source(source_prefix + "input_layernorm.weight", (1024,)),
            )
        )
            ...
            recipes.extend(
                (
                    ...
                    TensorRecipe(
                        ...
                        _source(source_prefix + "self_attn.o_proj.weight", (1024, 2048)),
                    ),
                )
            )
        else:
            ...
            recipes.extend(
                (
                    ...
                    TensorRecipe(
                        ...
                        _source(source_prefix + "linear_attn.in_proj_a.weight", (16, 1024)),
                    ),
                    TensorRecipe(
                    ...
                    TensorRecipe(
                        ...
                        _source(source_prefix + "linear_attn.out_proj.weight", (1024, 2048)),
                    ),
                )
            )
        ...
        recipes.extend(
            (
                TensorRecipe(
                    ...
                    _source(source_prefix + "post_attention_layernorm.weight", (1024,)),
                ),
                TensorRecipe(
                    object_prefix + "mlp/gate_up",
                    Concat(
                        (
                            _source(source_prefix + "mlp.gate_proj.weight", (3584, 1024)),
                            _source(source_prefix + "mlp.up_proj.weight", (3584, 1024)),
                        ),
                        0,
                    ),
                ),
                TensorRecipe(
                    ...
                    _source(source_prefix + "mlp.down_proj.weight", (1024, 3584)),
                ),
            )
        )
    ...
    recipes.extend(
        (
            TensorRecipe(
                "text/final_norm",
                _source("model.norm.weight", (1024,)),
            ),
            TensorRecipe(
                "text/output_head",
...
def _build_mtp_recipes() -> tuple[TensorRecipe, ...]:
    ...
    q_proj = source_prefix + "self_attn.q_proj.weight"
    return (
        TensorRecipe("mtp/input_projection", _source("mtp.fc.weight", (1024, 2048))),
        TensorRecipe(
            "mtp/embedding_norm",
            _source("mtp.pre_fc_norm_embedding.weight", (1024,)),
        ),
        TensorRecipe(
            "mtp/hidden_norm",
            _source("mtp.pre_fc_norm_hidden.weight", (1024,)),
        ),
        TensorRecipe(
        ...
        TensorRecipe("mtp/final_norm", _source("mtp.norm.weight", (1024,))),
    )
