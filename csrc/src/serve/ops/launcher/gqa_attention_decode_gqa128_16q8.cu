// One head geometry's small-T decode instantiations. Split out so the six
...
template void gqa_attention_small_t_launch_for<Gqa128_16q8, GqaAppendInput>(
...
template void gqa_attention_small_t_launch_for<Gqa128_16q8, GqaCachedInput>(
