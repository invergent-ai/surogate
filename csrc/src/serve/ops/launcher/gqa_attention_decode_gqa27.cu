...
template void gqa_attention_small_t_launch_for<Gqa27Geometry, GqaAppendInput>(
...
template void gqa_attention_small_t_launch_for<Gqa27Geometry, GqaCachedInput>(
