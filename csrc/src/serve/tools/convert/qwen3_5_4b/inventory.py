"""Persistent-object contract for the complete Qwen3.5-4B artifact.
    ...
    for layer in range(32):
        ...
        if layer in FULL_ATTENTION_LAYERS:
            ...
            specs.extend(
                (
                    ...
                    _tensor(prefix + "gdn/query_key_value_z", (12288, 2560), W8),
                    _tensor(prefix + "gdn/norm", (128,), BF16),
                    _tensor(prefix + "gdn/output", (2560, 4096), W8),
                )
            )
        ...
        specs.extend(
            (
                ...
                _tensor(prefix + "mlp/gate_up", (18432, 2560), W8),
                _tensor(prefix + "mlp/down", (2560, 9216), W8),
            )
        )
