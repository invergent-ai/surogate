...
from surogate.serve.convert.qwen3_5 import convert as convert_27b
from surogate.serve.convert.qwen3_5_moe import convert as convert_35b
...
MODEL_35B = Path(
    "/home/densemax2/work/models/hf/qwen/Qwen3.6-35B-A3B/base-hf-bf16"
)
