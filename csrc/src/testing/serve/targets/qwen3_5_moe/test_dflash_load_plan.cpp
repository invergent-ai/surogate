...
sinfer::family::StartupFeatures load_features(bool dflash) {
    return {
        .vision = !dflash,
        .speculative =
...
int main() {
    ...
    sinfer::artifact::Reader reader(path);
    {
        ...
        const auto plan =
            sinfer::targets::qwen3_5_moe::detail::bind_artifact(
                binder, load_features(false),
                sinfer::targets::qwen3_5_moe::detail::WeightsProfile::GroupwiseInt);
