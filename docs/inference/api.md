...
| `POST` | `/v1/decisions` (stable v1; aliases `/api/alpha/decisions`, `/api/v1/decisions`) | Decisions API: several single-token questions over one shared state; see [decisions.md](decisions.md) |
