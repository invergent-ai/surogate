    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            "flex items-center gap-2 rounded-md px-2 py-1 font-mono text-[9px] tabular-nums text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground",
            className,
          )}
        >
          <span>
