...
class ChatTemplateProcessor:
    ...
    def __init__(
        ...
        self.mode: Literal['pt', 'vllm', 'sglang',  # infer
        'train', 'rlhf', 'gkd'] = 'pt'  # train
        self.task_type: Literal[
            'causal_lm', 'seq_cls', 'embedding', 'prm', 'reranker', 'generative_reranker'] = 'causal_lm'
    ...
    def init_processor(self, processor: 'Processor') -> None:
        ...
        logger.info(f'default_system: {repr(self.chat_template.default_system)}')
        logger.info(f'max_length: {self.max_length}')
        logger.info(f'response_prefix: {repr(self.chat_template.response_prefix)}')
