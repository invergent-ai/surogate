...
class HfConfigFactory:
    ...
    @staticmethod
    def get_torch_dtype(config: PretrainedConfig | dict[str, Any], quant_info: dict[str, Any]) -> torch.dtype | None:
    ...
    @staticmethod
    def get_max_model_len(config: PretrainedConfig | dict[str, Any]) -> int | None:
    ...
    @staticmethod
    def set_max_model_len(config: PretrainedConfig | dict[str, Any], value: int):
    ...
    @staticmethod
    def get_quant_info(config: PretrainedConfig | dict[str, Any]) -> dict[str, Any] | None:
    ...
    @staticmethod
    def get_quant_info_from_hf_quant_config(model_dir: str) -> dict[str, Any] | None:
    ...
    @staticmethod
    def to_torch_dtype(torch_dtype: str | torch.dtype | None) -> torch.dtype | None:
        if torch_dtype is None:
            return None
    ...
    @staticmethod
    def get_config_attr(
        config: PretrainedConfig | dict[str, Any], attr_name: str, include_vit: bool = False
    ) -> Any | None:
