...
from surogate.core.model.kernels.flex_attention import torch_nn_functional_softmax
...
from surogate.core.model.kernels.utils import fast_linear_forward
from surogate.core.model.models.fast_llama import FastLlamaModel, LlamaRotaryEmbedding, \
    ...
    PeftModel_fast_forward, fix_prepare_inputs_for_generation, KV_CACHE_INCREMENT, \
    fast_rms_layernorm_inference, SDPA_HAS_GQA
