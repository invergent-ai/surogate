...
|---|---|---:|---:|---:|---:|---:|
| **surogate serve** | from GGUF Q4_K_M | **48 ms** | **503** | 4,733 † | 1.8 s | 2,314/0 |
...
| engine | weights | TTFT @1.9k | decode tok/s (1 user) | 100-user agg tok/s | 100-user TTFT p50 | 100-user reqs ok/err |
|---|---|---:|---:|---:|---:|---:|
| **surogate serve** | from GGUF Q4_K_M | **57 ms** | **214** | **1,736** † | 4.8 s | 1,304/0 |
...
- **100-user throughput: vLLM still wins where it serves, but the gap
  ...
  build for all engine cells): 1.3× at 0.8B (5,958 vs 4,733, was 4.7×)
  and 2.0× at 4B (3,390 vs 1,736 at `--max-concurrency 32`, was 9.6×),
