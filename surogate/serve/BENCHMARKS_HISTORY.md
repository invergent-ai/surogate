# Serving benchmarks — history and narrative

Moved out of BENCHMARKS.md on 2026-08-28 when the board was cut down to current rows. Everything below is the full record as it stood: superseded rows, the rejected levers, the profiles and the reasoning. The board of record is BENCHMARKS.md.
...
## Board as it stood on 2026-08-30, before the single-table consolidation

The per-model sections below are the board's text from 2026-08-28/29, kept verbatim; the board itself is now one table.
