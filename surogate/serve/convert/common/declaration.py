...
def symbols_for(config: dict[str, Any]) -> dict[str, int]:
    ...
    return {
        ...
        "GlmIndexerHeads": config.get("index_n_heads", 0),
        "GlmIndexerDim": config.get("index_head_dim", 0),
        "GlmIndexerQueryRows": config.get("index_n_heads", 0) * config.get("index_head_dim", 0),
        "GlmIndexerPool": config.get("index_kpool", 0),
