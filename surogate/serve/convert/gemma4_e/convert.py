...
def convert(
    ...
    *,
    ...
    with recipe.open_reader(model) as reader:
        ...
        with ArtifactWriter(
            output,
            ArtifactIdentity(inventory.MODEL_ID, inventory.WEIGHTS_ID, architecture="gemma4_e"),
            plan.specs,
    ...
    identity = ArtifactIdentity(inventory.MODEL_ID, inventory.WEIGHTS_ID, architecture="gemma4_e")
