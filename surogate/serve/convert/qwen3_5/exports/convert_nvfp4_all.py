...
from surogate.serve.artifact.container import Artifact, ArtifactIdentity, ArtifactWriter
...
def preflight_conversion(
    ...
    resources = (
        ...
        else family_conversion.load_resources(source, EXPORT.RESOURCE_SPECS)
    )
