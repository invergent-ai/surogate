...
Canonical invocation::
    ...
    python -m surogate.serve.convert.qwen3_5.convert --profile nvfp4-mixed-bf16 \
...
def preflight_conversion(
    ...
    base_source = family_recipe.preflight_sources(base)
    ...
    resources = family_convert.load_resources(base)
