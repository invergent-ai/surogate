...
from .recipe_nvfp4_mlp_only import (
    InputDivisorRecipe,
    MatrixPart,
    MatrixSource,
    Nvfp4WeightRecipe,
...
EXPORT = family_inventory.export_inventory(
    family_inventory.NVFP4_ALL, GEOMETRY)
...
DEQUANTIZED_CONTROL_LAYERS = EXPORT.GDN_LAYERS
...
def validate_recipe() -> None:
    ...
    expected = {
        spec.name for spec in EXPORT.TENSOR_SPECS if spec.format == EXPORT.NVFP4
    }
    ...
    divisor_names = {spec.name for spec in EXPORT.INPUT_SCALE_DIVISOR_SPECS}
