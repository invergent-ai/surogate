...
#: Which layers this export left at which width, asked of the profile table
#: rather than restated here.
EARLY_ATTENTION_INPUT_LAYERS = EXPORT.layers_at("attention_input", EXPORT.BF16)
NVFP4_ATTENTION_INPUT_LAYERS = EXPORT.layers_at("attention_input", EXPORT.NVFP4)
BF16_ATTENTION_OUTPUT_LAYERS = EXPORT.layers_at("attention_output", EXPORT.BF16)
NVFP4_ATTENTION_OUTPUT_LAYERS = EXPORT.layers_at("attention_output", EXPORT.NVFP4)
BF16_GDN_OUTPUT_LAYERS = EXPORT.layers_at("gdn_output", EXPORT.BF16)
NVFP4_GDN_OUTPUT_LAYERS = EXPORT.layers_at("gdn_output", EXPORT.NVFP4)
...
def _build_recipes() -> tuple[
    ...
    for layer in range(64):
        ...
        if layer in EXPORT.FULL_ATTENTION_LAYERS:
            ...
            if layer in NVFP4_ATTENTION_INPUT_LAYERS:
                group = (q, k, v)
            ...
            if layer in NVFP4_ATTENTION_OUTPUT_LAYERS:
                weights.append(
                    Nvfp4WeightRecipe(
            ...
            if layer in NVFP4_GDN_OUTPUT_LAYERS:
                weights.append(
                    Nvfp4WeightRecipe(
...
def _build_bf16_comparisons() -> tuple[Bf16Comparison, ...]:
    ...
    for layer in range(64):
        ...
        if layer in EXPORT.FULL_ATTENTION_LAYERS:
            ...
            if layer in BF16_ATTENTION_OUTPUT_LAYERS:
                result.append(
                    Bf16Comparison(
            ...
            if layer in BF16_GDN_OUTPUT_LAYERS:
                result.append(
                    Bf16Comparison(
