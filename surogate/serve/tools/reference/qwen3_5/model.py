"""Reference schedule for the hybrid GDN/attention decoder, over a native SInfer artifact."""
...
class RefModel:
    """Complete Text/MTP compute path, at whatever size the artifact declares."""
