...
This is the end-to-end keystone: a single ``dispatch_pp_debug_train_step`` chains the
...
def test_dispatch_train_step_converges_on_fixed_batch():
    ...
    n_steps = 15
    losses = [
        float(trainer.dispatch_pp_debug_train_step(b["inputs"], b["targets"], opt_config, i))
